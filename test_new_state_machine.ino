...
ADCSRA &= ~(1 << ADEN); //Using bitmasks in order to set the converter off.
//Using avr functions in order to turn off peripherals
power_adc_disable();
power_spi_disable();
power_twi_disable();
power_timer1_disable(); //Servo PWM
power_usart0_disable();
//Using D2 for the wake interrupt
pinMode(WAKE_PIN, INPUT_PULLUP); //D2
